...
class pyBulletRosWrapper(object):
    ...
    def __init__(self):
        ...
        plugin_import_prefix = rospy.get_param('~plugin_import_prefix', 'nightmare_pybullet.plugins')
...
def main():
    ...
    rospy.init_node('nightmare_pybullet', anonymous=False) # node name gets overrided if launched by a launch file
